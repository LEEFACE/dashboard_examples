...
# Create 3 data frames based on the above
...
def find_density(selectedData):
    ...
    rng_or_lp=list(selectedData.keys()) #Range or lasso points
    ...
    area = (max_x-min_x)*(max_y-min_y) #Gives you the area of that square
    d=pts/area
